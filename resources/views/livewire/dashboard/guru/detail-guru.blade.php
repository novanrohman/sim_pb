        ...
        <div class="container-fluid px-4">
            ...
            <main>
                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="id_mapel" id=""
                                                aria-describedby="emailHelpId"
                                                placeholder="{{ $guru->matapelajaran->mata_pelajaran ?? 'Tidak ada' }}" readonly>
                                        </div>
                    ...
                    <div class="col-4">
                        <a name="" id="" class="btn btn-outline-danger col-12 mb-4"
                            href="{{ url('/admin/data_guru') }}" role="button">Kembali</a>
                        <button class="btn btn-outline-warning col-12" wire:click='edit({{ $guru['id'] }})'
