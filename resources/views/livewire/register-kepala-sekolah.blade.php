<div>
    @slot('title')
        Register Kepala Sekolah - Sistem Presensi
    @endslot
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Buat Akun Kepala Sekolah!</h1>
                            </div>
                            <form class="user" wire:submit='storeKepalaSekolah'>
                                @csrf
                                <div class="form-group">
                                    <input wire:model.live='nama' type="text" class="form-control form-control-user"
